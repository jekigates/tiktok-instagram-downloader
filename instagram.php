    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-6 text-center pt-4">
                ...
                <div class="input-group mt-4">
                    <input type="text" class="form-control" placeholder="Search or paste instagram video or post link here" aria-label="Search or paste instagram video or post link here" aria-describedby="btn-start">
        ...
        <div class="row">
            <div class="col-xl-auto col-md-auto col-sm-12 d-flex justify-content-center mb-4">
                <img src="./image.jpg" class="img-thumbnail" alt="" style="width: 16rem; height: 20rem;">
            </div>
